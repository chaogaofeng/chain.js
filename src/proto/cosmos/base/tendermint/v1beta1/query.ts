...
export class ServiceClientImpl implements Service {
  ...
  GetNodeInfo(
    ...
    return this.rpc.unary(
      ServiceGetNodeInfoDesc,
      GetNodeInfoRequest.fromPartial(request),
      metadata
    );
  }
  ...
  GetSyncing(
    ...
    return this.rpc.unary(
      ServiceGetSyncingDesc,
      GetSyncingRequest.fromPartial(request),
      metadata
    );
  }
  ...
  GetLatestBlock(
    ...
    return this.rpc.unary(
      ServiceGetLatestBlockDesc,
      GetLatestBlockRequest.fromPartial(request),
      metadata
    );
  }
