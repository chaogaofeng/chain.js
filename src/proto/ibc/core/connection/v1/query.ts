...
export interface Query {
  ...
  Connection(
    request: DeepPartial<QueryConnectionRequest>,
...
export class QueryClientImpl implements Query {
  ...
  Connection(
    ...
    return this.rpc.unary(
      QueryConnectionDesc,
      QueryConnectionRequest.fromPartial(request),
      metadata
    );
  }
  ...
  Connections(
    ...
    return this.rpc.unary(
      QueryConnectionsDesc,
      QueryConnectionsRequest.fromPartial(request),
      metadata
    );
  }
  ...
  ClientConnections(
    ...
    return this.rpc.unary(
      QueryClientConnectionsDesc,
      QueryClientConnectionsRequest.fromPartial(request),
      metadata
    );
  }
