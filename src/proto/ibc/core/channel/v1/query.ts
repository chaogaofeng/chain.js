...
export class QueryClientImpl implements Query {
  ...
  Channel(
    ...
    return this.rpc.unary(
      QueryChannelDesc,
      QueryChannelRequest.fromPartial(request),
      metadata
    );
  }
  ...
  Channels(
    ...
    return this.rpc.unary(
      QueryChannelsDesc,
      QueryChannelsRequest.fromPartial(request),
      metadata
    );
  }
  ...
  PacketReceipt(
    ...
    return this.rpc.unary(
      QueryPacketReceiptDesc,
      QueryPacketReceiptRequest.fromPartial(request),
      metadata
    );
  }
  ...
  UnreceivedAcks(
    ...
    return this.rpc.unary(
      QueryUnreceivedAcksDesc,
      QueryUnreceivedAcksRequest.fromPartial(request),
      metadata
    );
  }
