...
export const QueryTobinTaxRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTobinTaxRequest>, I>>(
    object: I
  ): QueryTobinTaxRequest {
    const message = createBaseQueryTobinTaxRequest();
    message.denom = object.denom ?? '';
...
export const QueryTobinTaxResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTobinTaxResponse>, I>>(
    object: I
  ): QueryTobinTaxResponse {
    const message = createBaseQueryTobinTaxResponse();
...
export const QueryTobinTaxesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTobinTaxesRequest>, I>>(
    _: I
  ): QueryTobinTaxesRequest {
    const message = createBaseQueryTobinTaxesRequest();
    return message;
...
export const QueryTobinTaxesResponse = {
  ...
  toJSON(message: QueryTobinTaxesResponse): unknown {
    ...
    if (message.tobinTaxes) {
      obj.tobinTaxes = message.tobinTaxes.map(e =>
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTobinTaxesResponse>, I>>(
    object: I
  ): QueryTobinTaxesResponse {
    const message = createBaseQueryTobinTaxesResponse();
    message.tobinTaxes =
  ...
  fromJSON(object: any): QueryAggregateVotesResponse {
    return {
      aggregateVotes: Array.isArray(object?.aggregateVotes)
        ? object.aggregateVotes.map((e: any) =>
...
export class QueryClientImpl implements Query {
  ...
  ExchangeRate(
    ...
    return this.rpc.unary(
      ...
      QueryExchangeRateRequest.fromPartial(request),
      metadata
    );
  }
  ...
  ExchangeRates(
    ...
    return this.rpc.unary(
      QueryExchangeRatesDesc,
      QueryExchangeRatesRequest.fromPartial(request),
      metadata
    );
  }
  ...
  TobinTax(
    ...
    return this.rpc.unary(
      QueryTobinTaxDesc,
      QueryTobinTaxRequest.fromPartial(request),
      metadata
    );
  }
  ...
  TobinTaxes(
    ...
    return this.rpc.unary(
      QueryTobinTaxesDesc,
      QueryTobinTaxesRequest.fromPartial(request),
      metadata
    );
  }
  ...
  Actives(
    ...
    return this.rpc.unary(
      QueryActivesDesc,
      QueryActivesRequest.fromPartial(request),
      metadata
    );
  }
  ...
  VoteTargets(
    ...
    return this.rpc.unary(
      QueryVoteTargetsDesc,
      QueryVoteTargetsRequest.fromPartial(request),
      metadata
    );
  }
  ...
  MissCounter(
    ...
    return this.rpc.unary(
      QueryMissCounterDesc,
      QueryMissCounterRequest.fromPartial(request),
      metadata
    );
  }
  ...
  AggregateVote(
    ...
    return this.rpc.unary(
      QueryAggregateVoteDesc,
      QueryAggregateVoteRequest.fromPartial(request),
      metadata
    );
  }
  ...
  AggregateVotes(
    ...
    return this.rpc.unary(
      QueryAggregateVotesDesc,
      QueryAggregateVotesRequest.fromPartial(request),
      metadata
    );
  }
